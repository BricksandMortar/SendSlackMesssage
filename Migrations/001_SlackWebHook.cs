...
using Rock.Plugin;
namespace com.bricksandmortar.SendSlackMessage.Migrations
{
    ...
    public class SlackWebHook : Migration
    {
        ...
        {
            RockMigrationHelper.AddDefinedType("Communication", "Slack", "All of your webhooks set up for use with Slack", "495981C4-BD0E-4C9A-9FA1-50E07DB2DAB8", @"Obtain your webhook by creating an ''incoming webhook'' Slack service integration. The values given in your webhook integration can be overridden at the workflow action level.");
